...
bool TipCons::doMatch(TipType const *t) const {
  ...
  if (sameType<TipFunction>(t, this) || sameType<TipInt>(t, this) ||  sameType<TipBool>(t, this) ||
      sameType<TipRecord>(t, this) || sameType<TipRef>(t, this) || sameType<TipArray>(t, this)) {
