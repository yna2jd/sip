...
public:
  ...
  virtual void endVisit(ASTBoolLiteralExpr *element) override;
  ...
  virtual bool visit(ASTForRngStmt *element) override;
  virtual void endVisit(ASTForRngStmt *element) override;
